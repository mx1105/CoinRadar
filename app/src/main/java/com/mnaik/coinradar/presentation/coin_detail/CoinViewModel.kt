...
import com.mnaik.coinradar.domain.use_case.get_coin.GetCoinUseCase
...
class CoinViewModel @Inject constructor(
    private val getCoinUseCase: GetCoinUseCase, private val savedStateHandle: SavedStateHandle
) : ViewModel() {
